...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\LogSuspiciousActivities::class,
    ];
    ...
    protected $middlewareAliases = [
        ...
        'admin.redirect' => \App\Http\Middleware\RedirectAdminToAdminDashboard::class,
        'switch.user' => \App\Http\Middleware\SwitchUserMiddleware::class,
        'driver' => \App\Http\Middleware\DriverMiddleware::class,
        'driver.redirect' => \App\Http\Middleware\RedirectDriverToDriverDashboard::class,
    ];
    ...
    protected $routeMiddleware = [
        // Removed duplicate middleware registrations - use middlewareAliases instead
    ];
} 